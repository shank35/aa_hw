...
describe Dessert do
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { brownie.eat(100)}.to raise_error("amount greater thsn the quantity")
    end
  end

  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Shan")
      expect(brownie.serve).to eq("Chef Shan has made 50 brownies!")
    end
  end
